...
func TestDagCreation_ValidFile(t *testing.T) {
	task, err := UnmarshalTaskFromFile(gocontext.Background(), "testdata/acb.yaml", nil, "", true, "./global-defaults-linux.yaml")
	if err != nil {
...
func TestBuildxInBuildTask_ValidFile(t *testing.T) {
	task, err := UnmarshalTaskFromFile(gocontext.Background(), "testdata/buildx.yaml", nil, "samsTask", true, "./global-defaults-linux.yaml")
	if err != nil {
		t.Fatalf("Failed to create task from file. Err: %v", err)
	}
...
func TestBuildxQuickRun_ValidFile(t *testing.T) {
	task, err := UnmarshalTaskFromFile(gocontext.Background(), "testdata/buildx.yaml", nil, "", true, "./global-defaults-linux.yaml")
	if err != nil {
		t.Fatalf("Failed to create task from file. Err: %v", err)
	}
