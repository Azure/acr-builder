...
az: mcr.microsoft.com/acr/azure-cli:fe316c9
bash: mcr.microsoft.com/acr/bash:fe316c9
curl: mcr.microsoft.com/acr/curl:fe316c9
cssc: mcr.microsoft.com/acr/cssc:fe316c9
`
